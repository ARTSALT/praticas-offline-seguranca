...
public class KeyManager {
    ...
    public KeyManager() {
        ...
        chavesAES.put("P0", new SecretKeySpec(aes1, 0, aes1.length, "AES"));
        chavesHMAC.put("P0", "641f00d6032ac82902d745c28fd7c570b00067391c6d7b7226cccb9a40695ef0");

        byte[] aes2 = hex2Byte("ee8278dc041b3ecd2ca090d88698e53d6b25d9392d1cf51ad8e56c86d45342c9");

        chavesAES.put("P1", new SecretKeySpec(aes2, 0, aes2.length, "AES"));
        chavesHMAC.put("P1", "2da6e67a02ad431a083db8d4f902f23609dfd62c9593a58917a1fa5503286dbf");

        byte[] aes3 = hex2Byte("a1b16a83e617018c0b4c529e7eaa820afc667c2f89fd3f084c4b5f6ac0c4fd8f");

        chavesAES.put("P2", new SecretKeySpec(aes3, 0, aes3.length, "AES"));
        chavesHMAC.put("P2", "692d07cd4ffc81b9ecb1cf621bc9f4d3468a7284a8b123b4a3b344726b6bf085");

        byte[] aes4 = hex2Byte("8a5c8f4a403487761aedd2316e13e832e278d60c989e2db053f98f1f4449d5a9");

        chavesAES.put("P3", new SecretKeySpec(aes4, 0, aes4.length, "AES"));
        chavesHMAC.put("P3", "6e07c3ee123662290e7f80c891c72c995fd78e2372e7804c64089ded6d07831e");

        byte[] aes5 = hex2Byte("df58e311fad67b5ae8a831c4fe5584dfb2d2e9102f7255de8c30604acaa93b69");

        chavesAES.put("P4", new SecretKeySpec(aes5, 0, aes5.length, "AES"));
        chavesHMAC.put("P4", "a6366e21f073f44e0ba013d47a08b1a190a4cd847361de100f6453f4bda41cc6");

        byte[] aes6 = hex2Byte("9925b51193f8e91402a29f131b44902cc756137506e046e09b43683a2bc0e2e0");

        chavesAES.put("P5", new SecretKeySpec(aes6, 0, aes6.length, "AES"));
        chavesHMAC.put("P5", "72c573312f8b6d61e727a25a975211143e951011d86e161b87d0d0aa8bbb407b");

        byte[] aes7 = hex2Byte("e309a0a1b11da1f370fdc035546adbe8ab8d167966418cc954eb06a652adf5f2");

        chavesAES.put("P7", new SecretKeySpec(aes7, 0, aes7.length, "AES"));
        chavesHMAC.put("P7", "186caceefe48f14ffd3d0e324dcf8e2a7a55f87add6bf2d7ee3142364ce34380");
